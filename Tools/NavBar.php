...
if (isset($_SESSION['sessionId'])) {
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="/ProjethopitalPhP/"><i class="flaticon-pharmacy"></i><span>Remedic</span></a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a href="/ProjethopitalPhP/" class="nav-link">Accueil</a></li>

                    <li class="nav-item active"><a href="/ProjethopitalPhP/View/Page/aPropos.php"
                                                   class="nav-link">A propos</a></li>
                    <li class="nav-item active"><a href="/ProjethopitalPhP/View/Page/departement.php"
                                                   class="nav-link">Département</a></li>
                    <li class="nav-item active"><a href="/ProjethopitalPhP/View/Page/docteur.php"
                                                   class="nav-link">Docteur</a></li>
                    <li class="nav-item active"><a href="/ProjethopitalPhP/View/Page/contact.php"
                    ...
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false" onclick="masquer_div('badge');">
                            Mon Profil
                        </button>
                        ...
                        <div class="dropdown-menu">
                            ...
                            if ($data['dossier'] == 0) {
                                ...
                                <div>
                                    ...
                                    <a class="dropdown-item" href="#" data-toggle="modal"
                                       data-target="#DossierCréation">Faire mon dossier</a>
                                </div>
                                ...
                                <a class="dropdown-item"
                                   href="/ProjethopitalPhP/View/gestionUser/VoirDossier.php">Voir mon
                                    dossier</a>
                            ...
                            if ($data['profil'] == 'medecin') {
                                ...
                                <div>
                                    <span class="admin"></span>
                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#">Panel
                                        Medecin</a>
                                </div>
                            ...
                            <a class="dropdown-item" href="/ProjethopitalPhP/View/RendezVous/MesRendezVous.php">Mes
                                rendez-vous</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="/ProjethopitalPhP/Traitement/User/decoT.php">Déconnexion</a>
                        </div>
...
//quand le User est déconnecté
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active"><a href="/ProjethopitalPhP/index.php"
                    ...
                    <li class="nav-item cta"><a href="contact.html" class="nav-link" style="margin-right: 5px;"
                                                data-toggle="modal" data-target="#Connexion"><span>Connexion</span></a>
                    </li>
                    <li class="nav-item cta"><a href="contact.html" class="nav-link" data-toggle="modal"
                                                data-target="#Inscription"><span>Inscription</span></a></li>
                </ul>
            </div>
        </div>
    </nav>
...
<!-- Connexion -->
<div class="modal fade" id="Connexion" tabindex="-1" role="dialog" aria-labelledby="modalAppointmentLabel"
     aria-hidden="true">
            ...
            <div class="modal-body">
                <form action="/ProjethopitalPhP/Traitement/User/connexionT.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <label for="appointment_mdp" class="text-black" class="sr-only" name="mdp">Mot de passe
                            :</label>
...
<!--Inscription -->
<div class="modal fade" id="Inscription" tabindex="-1" role="dialog" aria-labelledby="modalAppointmentLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="/ProjethopitalPhP/Traitement/User/inscriptionT.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <img href='#' src="https://img.icons8.com/material/24/000000/visible--v1.png" id="icon2"
                             onclick="showHidePassword('mdp')"/>
                    ...
                    <div class="form-group">
                        ...
                        <label for="appointment_mdp" class="text-black" name="mdp2">Réecrivez votre mot de passe
                            :</label>
...
<!--Dossier Création -->
<div class="modal fade" id="DossierCréation" tabindex="-1" role="dialog" aria-labelledby="modalAppointmentLabel"
     aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <form action="/ProjethopitalPhP/Traitement/Dossier/dossierPatienT.php" method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="appointment_name" class="text-black" name="date"><b>Date de
                                            naissance</b></label>
                                ...
                                <div class="form-group">
                                    <label for="appointment_name" class="text-black"
                                           name="adresse"><b>Adresse</b></label>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="appointment_name" class="text-black" name="sq"><b>Sécurité
                                            sociale</b></label>
                                ...
                                <div class="form-group">
                                    <div class="row" style="margin-left: 0px;margin-bottom: -50px;">
                                        ...
                                        <!-- Option Tv -->
                                        <div class="form-group">
                                            <label for="appointment_name" class="text-black" name="tvradio"><b>Option
                                                    TV</b></label>
                                        ...
                                        <div class="form-group" style="margin-left: 50px;">
                                            <label for="appointment_name" class="text-black" name="wifiradio"><b>Option
                                                    Wifi</b></label>

                                            <div class="form-group">
                                                <label for="wifiOui">Oui</label>
                                                <input type="radio" value="1" id="wifiOui" name="wifiradio"
                                                       checked> </br>
